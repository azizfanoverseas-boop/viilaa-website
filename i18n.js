(function () {
  ...
  const translations = {
    ...
    "Advanced chip packages, AI accelerators, high-performance computing, and data-center hardware.": ["用于先进芯片封装、AI 加速器、高性能计算及数据中心硬件。", "첨단 칩 패키지, AI 가속기, 고성능 컴퓨팅 및 데이터 센터 하드웨어에 사용됩니다."],
    ...
    "Curved OLED cockpits, flexible control surfaces, and next-generation professional displays.": ["用于曲面 OLED 座舱、柔性控制界面及新一代专业显示终端。", "곡면 OLED 콕핏, 플렉시블 제어 표면 및 차세대 전문 디스플레이에 사용됩니다."],
    "Smartphone OLED screens, large-format OLED displays, and next-generation professional display terminals.": ["用于手机 OLED 屏幕、大型 OLED 显示屏及新一代专业显示终端。", "스마트폰 OLED 화면, 대형 OLED 디스플레이 및 차세대 전문 디스플레이 단말기에 사용됩니다."],
    ...
    "Aerospace imaging, infrared sensing, precision laser systems, and protected optical assemblies.": ["用于航空航天成像、红外传感、精密激光系统及防护光学组件。", "항공우주 이미징, 적외선 센싱, 정밀 레이저 시스템 및 보호 광학 어셈블리에 사용됩니다."],
    "Doped optical fibers, coated optical glass, Faraday rotator crystals, YAG, and scintillation crystals.": ["涵盖掺杂光纤、镀膜光学玻璃、法拉第旋光晶体、YAG 及闪烁晶体。", "도핑 광섬유, 코팅 광학 유리, 패러데이 회전 결정, YAG 및 섬광 결정을 포함합니다."],
    ...
    "Permanent-magnet traction motors, industrial drives, and high-efficiency generation systems.": ["用于永磁牵引电机、工业驱动及高效发电系统。", "영구자석 구동 모터, 산업용 드라이브 및 고효율 발전 시스템에 사용됩니다."],
