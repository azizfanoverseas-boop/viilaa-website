(function () {
  ...
  const translations = {
    ...
    "Selected certificate covers are shown below. Open any card to view the source PDF.": ["以下精选展示证书首页，点击卡片可查看原始 PDF。", "아래에는 주요 인증서 표지를 선별해 표시하며, 카드를 열면 원본 PDF를 볼 수 있습니다."],
