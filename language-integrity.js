(function () {
  ...
  const copy = {
    ...
    en: {
      ...
      "04 / 确定验证项目": "04 / DEFINE VERIFICATION",
      "04 / 询价": "04 / REQUEST FOR QUOTE",
      "检测与验证": "TESTING & VERIFICATION",
      "检测不是设备清单，而是采购判断依据。": "Testing is evidence for procurement decisions—not an equipment list.",
      "质量是我们的信誉和你采购的依据，告诉我们您的检测要求。": "Quality is our reputation and the basis for your purchasing decisions. Tell us your testing requirements.",
      "检测结果清晰可追溯": "Clear, Traceable Test Results",
      "样品信息、检测方法与关键数据统一记录，支持采购评估与质量复核。": "Sample information, test methods, and key data are recorded consistently to support purchasing evaluation and quality review.",
      ...
      "检测方案可根据材料形态、纯度指标与应用要求进行匹配。": "Testing plans can be matched to material form, purity criteria, and application requirements.",
      "沟通检测要求": "Discuss Testing Requirements",
      ...
      "03 / 衔接后续供货": "03 / SUPPORT REPEAT SUPPLY",
    ...
    ko: {
      ...
      "形态 / 尺寸 / 公差": "형태 / 치수 / 공차",
      "数量 / 包装 / 储存": "수량 / 포장 / 보관",
      "04 / 确定验证项目": "04 / 검증 항목 정의",
      "04 / 询价": "04 / 견적 문의",
      "检测与验证": "시험 및 검증",
      "检测不是设备清单，而是采购判断依据。": "시험은 장비 목록이 아니라 구매 판단의 근거입니다.",
      "质量是我们的信誉和你采购的依据，告诉我们您的检测要求。": "품질은 우리의 신뢰이며 귀사의 구매 판단 기준입니다. 필요한 시험 요구사항을 알려주세요.",
      "QUALITY EVIDENCE": "품질 근거",
      "检测结果清晰可追溯": "명확하고 추적 가능한 시험 결과",
      "样品信息、检测方法与关键数据统一记录，支持采购评估与质量复核。": "시료 정보, 시험 방법 및 핵심 데이터를 일관되게 기록하여 구매 평가와 품질 검토를 지원합니다.",
      "元素分析": "원소 분석",
      "扫描电镜": "주사전자현미경",
      "物相分析": "상 분석",
      "气体分析": "가스 분석",
      "粒度分析": "입도 분석",
      "密度分析": "밀도 분석",
      "检测方案可根据材料形态、纯度指标与应用要求进行匹配。": "소재 형태, 순도 기준 및 적용 요구사항에 맞춰 시험 방안을 구성할 수 있습니다.",
      "沟通检测要求": "시험 요구사항 상담",
      "扫描电子显微镜": "주사전자현미경",
      "X 射线衍射仪": "X선 회절 분석기",
